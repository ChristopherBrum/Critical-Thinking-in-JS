...
Output: 1 number
- the number output is the nth fibonacci value 

Rules:
- return the nth fibonacci value in the sequence
- n is the given argument
- fibonacci values are determined by adding the last two fibonacci numbers together, starting with 1 and 1.
- e.g., 1, 1, 2, 3, 5, 8, 
